...
<div class="container">
  <?= form_open_multipart('admin/saveArticle'); ?>
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <div>
          <input style="display: none;" type="file" class="form-control" id="inputImage" placeholder="Image" name="image" value="<?= set_value('image') ?>"></textarea>  
        </div>
